      ...
      <section className="py-20" style={{ backgroundColor: '#F6F6FF' }}>
        <div className="w-full max-w-[1440px] mx-auto px-20 md:px-[60px] lg:px-[120px]">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-[44px] font-semibold text-black text-center mb-[60px]">
              Overview
            </h2>
            <p className="text-[24px] leading-relaxed" style={{ color: '#212121' }}>
      ...
      <section className="py-20" style={{ backgroundColor: '#F6F6FF' }}>
        <div className="w-full max-w-[1440px] mx-auto px-20 md:px-[60px] lg:px-[120px]">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-[44px] font-semibold text-black mb-[60px] text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                <div>
                  ...
                  <p className="text-[24px] leading-relaxed max-w-[600px]" style={{ color: '#212121' }}>
                ...
                <div>
                  ...
                  <p className="text-[24px]" style={{ color: '#212121' }}>12 Weeks</p>
                </div>
                
                <div>
                  <h3 className="text-[32px] font-bold text-black mb-4">Client</h3>
                  <p className="text-[24px]" style={{ color: '#212121' }}>Easy Commute</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[24px]" style={{ color: '#212121' }}>Figma, Pen and Paper Sketch, Google Docs, Miro</p>
                </div>
                
                <div>
                  <h3 className="text-[32px] font-bold text-black mb-4">Skills</h3>
                  <p className="text-[24px]" style={{ color: '#212121' }}>
      ...
      <section className="py-20" style={{ backgroundColor: '#F6F6FF' }}>
        <div className="w-full max-w-[1440px] mx-auto px-20 md:px-[60px] lg:px-[120px]">
          ...
          >
            ...
            <p className="text-[24px] mb-8 text-left" style={{ color: '#212121' }}>
      ...
      <section className="py-20" style={{ backgroundColor: '#F6F6FF' }}>
        <div className="w-full max-w-[1440px] mx-auto px-20 md:px-[60px] lg:px-[120px]">
          ...
          >
            ...
            <div className="mb-12">
              <p className="text-[24px] leading-relaxed text-left" style={{ color: '#212121' }}>
      ...
      <section className="py-20" style={{ backgroundColor: '#F6F6FF' }}>
        <div className="w-full max-w-[1440px] mx-auto px-20 md:px-[60px] lg:px-[120px]">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-[44px] font-semibold text-black text-center mb-[30px]">
