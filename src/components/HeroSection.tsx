...
const HeroSection = () => {
  return (
    <div className="w-full max-w-[1513px] mb-20 mx-auto pt-[120px] md:pt-[150px] h-screen min-h-[1000px] md:min-h-[500px] md:max-h-[750px] lg:max-h-[850px] bg-white  relative">
      {/* Header Navigation */}
