...
const HeroSection = () => {
  return (
    <div className="pt-[80px] md:pt-[120px] h-screen md:max-h-[750px] lg:max-h-[945px] bg-white max-w-[1440px] mx-auto relative">
      ...
      {/* Main Hero Content */}
      <div id="about-me" className="min-h-[600px] w-full flex flex-col md:flex-row items-start px-[20px] sm:px-[40px] lg:px-[60px] xl:px-[80px] lg:pt-16 pb-28 lg:pb-32 relative">
        ...
        >
          ...
          <div className='flex mx-auto min-[500px]:hidden flex-col items- gap-2 mt-14'>
            <motion.div
              className=""
            >
        ...
        {/* Right Side - Image */}
        <motion.div
          className="hidden md:block absolute bottom-0 md:bottom-auto right-0 md:-translate-y-[25%] lg:-translate-y-[15%] w-full max-w-[400px] lg:max-w-[758px] md:w-[400px] lg:w-[500px] xl:w-[758px] h-auto mt-8 lg:mt-0"
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
      ...
      <motion.div
        className="w-full px-[20px] md:px-[40px] lg:px-[80px] min-[500px]:w-[60%] md:w-full absolute bottom-0 -translate-y-[20%] min-[420px]:-translate-y-[40%] min-[500px]:-translate-y-[50%] left-0 flex flex-col md:flex-row items-start md:items-center justify-between z-20 space-y-6 lg:space-y-0 gap-4"
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <motion.div
          className="hidden min-[500px]:block flex flex-col items-end max-w-md"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <p className="text-gray-900 text-lg lg:text-xl font-medium leading-relaxed text-left">
            Abdul's Professional execution elevated our brand experience. Strongly endorsed.
          </p>
        </motion.div>
      ...
      {/* Right Side - Image */}
      <motion.div
        className="md:hidden absolute w-full max-w-[400px] h-auto right-0 -translate-y-[40%]"
        initial={{ opacity: 0, x: 50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.8, delay: 0.4 }}
      >
